          ...
          <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul id="active" class="nav navbar-nav side-nav">
                    ...
                    <li class="selected"><a href="./historique.php"><i class="fa fa-list-ol"></i>Historique</a></li>
            ...
            <div class="row">
             ...
             if(isset($_SESSION['login'])){
						...
						$reponse = $bdd->prepare('SELECT titres.id,titres.nom,albums.cover,artistes.nom as anom FROM titres_albums,albums,titres,artistes_titres,artistes,historiques, comptesutilisateurs WHERE
							 titres_albums.titre = titres.id and titres_albums.album = albums.id and artistes_titres.artiste = artistes.id and
               artistes_titres.titre = titres.id and historiques.utilisateur = comptesutilisateurs.login and historiques.titre = titres.id and 
               comptesutilisateurs.login = ? order by titres.nom');
