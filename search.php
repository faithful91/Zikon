            ...
            <div class="row">
                ...
                <div class="col-lg-12">
					  <h2 id='result'></h2>
						...
						$reponse = $bdd->prepare('SELECT titres.id,titres.nom,albums.cover,artistes.nom as anom FROM titres_albums,albums,titres,artistes_titres,artistes WHERE
							 titres_albums.titre = titres.id and titres_albums.album = albums.id and artistes_titres.artiste = artistes.id and
               artistes_titres.titre = titres.id and ( titres.nom like ? or albums.nom like ? or artistes.nom like ? ) 
							 order by titres.nom');
            $reponse->execute(array("%".$_POST['text']."%","%".$_POST['text']."%","%".$_POST['text']."%"));
						?>
