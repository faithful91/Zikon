...
?>
  <div class="col-lg-4 col-sm-6 col-xs-12" style="color:#000000">
    <strong> <?php echo $donnees['nom']; ?> </strong>
        <a href="#" onclick="return afficherArtiste(<?php echo $donnees['id']; ?>);">
             <img src="<?php echo $donnees['photo']; ?>" width="300" height="300" class="thumbnail img-responsive">
        </a>
  </div>
...
function afficherArtiste(artisteId){
